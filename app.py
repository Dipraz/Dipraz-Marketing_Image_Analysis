...
# --- Streamlit App ---
st.title("Marketing Media Analysis AI Assistant with gemini-2.5-pro-preview-03-25")
...
st.title("Marketing Image Comparison AI Assistant with Gemini-2.5-pro-preview-03-25")
