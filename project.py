...
# --- Streamlit App ---
st.title("Marketing Media Analysis AI Assistant with gemini-2.5-flash-lite-preview-06-17")
...
st.title("Marketing Image Comparison AI Assistant with gemini-2.5-flash-lite-preview-06-17")
